...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		//页面加载完后请求最新图片
		$.post("${pageContext.request.contextPath}/pic/citypic.action",function(data){
			$(data).each(function(){
...
<body>
	...
	<div class="wrap" id="header">
			...
			<!-- 放置logo -->
				<div class="logo">
					<a href="${pageContext.request.contextPath }/city/backindex.action"><img src="${pageContext.request.contextPath }/photo/l2.png" /></a>
				</div>
	...
	<div class="navigation-strip">
		<div class="container">
			<div class="nav_content">
				<div class="home">
					<a href="${pageContext.request.contextPath }/city/backindex.action"><img src="${pageContext.request.contextPath }/images/home1.png" alt="" /></a>
				</div>
				<div class="search">
					<form>
				...
				<div class="top-menu">
					<ul>
						...
						<li><a class="active" href="javascript:void(0)">城市风光</a></li>
