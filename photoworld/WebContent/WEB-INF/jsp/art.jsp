...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$.post("${pageContext.request.contextPath}/pic/artpic.action",function(data){
			$(data).each(function(){
	...
	<div class="navigation-strip">
		<div class="container">
			<div class="nav_content">
				<div class="home">
					<a href="${pageContext.request.contextPath }/art/backindex.action"><img src="${pageContext.request.contextPath }/images/home1.png" alt="" /></a>
				</div>
				<div class="search">
					<form>
				...
				<div class="top-menu">
					<ul>
						<li><a class="active" href="javascript:void(0)">文化艺术</a></li>
