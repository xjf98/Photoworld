...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		//页面加载完后请求最新图片
		$.post("${pageContext.request.contextPath}/pic/tourismpic.action",function(data){
			$(data).each(function(){
	...
	<div class="navigation-strip">
		<div class="container">
			<div class="nav_content">
				<div class="home">
					<a href="${pageContext.request.contextPath }/tourism/backindex.action"><img src="${pageContext.request.contextPath }/images/home1.png" alt="" /></a>
				</div>
				<div class="search">
					<form>
				...
				<div class="top-menu">
					<ul>
						...
						<li><a class="active" href="javascript:void(0)">旅游地理</a></li>
